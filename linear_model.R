...
#' @description This function will run a linear model and apply gradient descent
#' @param
#' formula take a formula
#' dataframe  a data frame
#' contrasts  a list of constrasts for factor variables
#' @examples
#' data(iris)
...
print.linear_model<-function(x, ...){
  cat("\nCoefficients:\n")
  print.default(ret$coefficients)
